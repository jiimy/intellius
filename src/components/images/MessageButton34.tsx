...
const MessageButton34 = ({ onClick, fill = "#D8D8D8" }: ImgTypes) => {
  return (
    <svg width="34" height="35" viewBox="0 0 34 35" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={onClick}>
      ...
      <path d="M23.6972 15.5821L17.2222 8.97501M17.2222 8.97501L10.7472 15.5821M17.2222 8.97501V26.594" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
